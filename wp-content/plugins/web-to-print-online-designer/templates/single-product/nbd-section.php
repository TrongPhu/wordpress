...
<div class="nbdesigner_frontend_container">
    <input name="nbd-add-to-cart" type="hidden" value="<?php esc_attr_e( $pid ); ?>" />
    <?php if( nbdesigner_get_option( 'nbdesigner_separate_design_buttons', 'no' ) == 'no' ): ?>
    <p>
        <a class="button nbdesigner_disable alt nbdesign-button <?php esc_attr_e( $class ); ?>" id="triggerDesign" >
    ...
    <?php else: ?>
        <div class="nbd-actions-wrap">
            ...
            <div class="nbd-action-wrap">
                <a class="button alt nbdesign-button start-design" href="<?php echo $template_gallery_url;?>">
